...
public class SearchRepository {
	...
	public void init(){
		SQL_SEARCH =
				...
				" UNION ALL " +
				"SELECT name, 'Расы и происхождения ' as section, CONCAT('/races/', REPLACE(LOWER(english_name), ' ', '_')) url, description FROM races WHERE name LIKE :name OR alt_name LIKE :name OR english_name LIKE :name" +
				"  UNION ALL " +
